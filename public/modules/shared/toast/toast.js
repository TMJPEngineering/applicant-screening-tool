(function () {
    ...
    angular
        ...
        .directive('tmjToast', tmjToast)
        .directive('tmjToastClosable', tmjToastClosable)
        .service('toast', toast)
    tmjToast.$inject = ['$animate', '$animateCss', '$timeout', 'toast', 'toastConfig'];
    toast.$inject = ['$rootScope', '$compile', '$document', 'toastConfig'];

    function tmjToast($animate, $animateCss, $timeout, toast, toastConfig) {
    ...
    function toast($rootScope, $compile, $document, toastConfig) {
        var _self = this;
